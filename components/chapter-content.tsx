...
export function ChapterContent({
  ...
  return (
    <div className="bg-card p-6 rounded-lg shadow-lg">
      ...
      <div className="max-w-4xl w-full mx-auto px-4 py-8 space-y-6 md:text-[20px] text-[16px] text-gray-800 dark:text-gray-300 break-words whitespace-normal overflow-hidden" dangerouslySetInnerHTML={{ __html: content }} />
    </div>
  );
}
